...
{
    public class RecenzijaService : BaseCRUDService<Model.Recenzija, RecenzijaSearchObject, Database.Recenzija, RecenzijaUpsertRequest, RecenzijaUpsertRequest>, IRecenzijaService
    {
