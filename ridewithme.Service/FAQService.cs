...
{
    public class FAQService : BaseCRUDService<Model.FAQ, FAQSearchObject, Database.FAQ, FAQInsertRequest, FAQUpdateRequest>, IFAQService
    {
        public FAQService(RidewithmeContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        }

        public override IQueryable<FAQ> AddFilter(FAQSearchObject searchObject, IQueryable<FAQ> query)
        {
        ...
        public Model.FAQ Delete(int id)
        {
            ...
            return Mapper.Map<Model.FAQ>(entity);
        }
